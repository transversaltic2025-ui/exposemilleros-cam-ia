...
const analysisSchema = z.object({
  ...
  recomendaciones_genero_ia: list, enfoque_etnico_ia: text, nivel_inclusion_etnica_ia: score,
  recomendaciones_etnicas_ia: list, enfoque_diferencial_ia: text, riesgos_exclusion_ia: list,
...
Los once campos de lista deben conservar los corchetes aunque tengan un solo elemento. Esto incluye recomendaciones_genero_ia y recomendaciones_etnicas_ia. Ejemplo correcto: "acciones_genero_recomendadas_ia":["Fortalecer la documentación explícita de la participación de mujeres en la formulación.","Identificar roles de mujeres en la ejecución del proyecto."]. Ejemplo incorrecto: "acciones_genero_recomendadas_ia":"Fortalecer la documentación explícita de la participación de mujeres.".
